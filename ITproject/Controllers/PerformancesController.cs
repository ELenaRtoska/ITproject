...
namespace ITproject.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PerformanceId,PerformanceName,Description")] Performance performance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PerformanceId,PerformanceName,Description")] Performance performance)
        {
            if (ModelState.IsValid)
            {
